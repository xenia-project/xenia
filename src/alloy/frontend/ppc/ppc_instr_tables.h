...
static InstrType instr_table_4_unprep[] = {
  ...
  INSTRUCTION(vaddubm,        0x10000000, VX , General        , 0                 , "Vector Add Unsigned Byte Modulo"),
  INSTRUCTION(vaddubs,        0x10000200, VX , General        , 0                 , "Vector Add Unsigned Byte Saturate"),
  INSTRUCTION(vadduhm,        0x10000040, VX , General        , 0                 , "Vector Add Unsigned Half Word Modulo"),
  ...
  INSTRUCTION(vavgub,         0x10000402, VX , General        , 0                 , "Vector Average Unsigned Byte"),
  INSTRUCTION(vavguh,         0x10000442, VX , General        , 0                 , "Vector Average Unsigned Half Word"),
  INSTRUCTION(vavguw,         0x10000482, VX , General        , 0                 , "Vector Average Unsigned Word"),
  INSTRUCTION(vcfsx,          0x1000034A, VX , General        , 0                 , "Vector Convert from Signed Fixed-Point Word"),
  INSTRUCTION(vcfux,          0x1000030A, VX , General        , 0                 , "Vector Convert from Unsigned Fixed-Point Word"),
  INSTRUCTION(vctsxs,         0x100003CA, VX , General        , 0                 , "Vector Convert to Signed Fixed-Point Word Saturate"),
  INSTRUCTION(vctuxs,         0x1000038A, VX , General        , 0                 , "Vector Convert to Unsigned Fixed-Point Word Saturate"),
  INSTRUCTION(vexptefp,       0x1000018A, VX , General        , 0                 , "Vector 2 Raised to the Exponent Estimate Floating Point"),
  INSTRUCTION(vlogefp,        0x100001CA, VX , General        , 0                 , "Vector Log2 Estimate Floating Point"),
  INSTRUCTION(vmaxfp,         0x1000040A, VX , General        , 0                 , "Vector Maximum Floating Point"),
  INSTRUCTION(vmaxsb,         0x10000102, VX , General        , 0                 , "Vector Maximum Signed Byte"),
  INSTRUCTION(vmaxsh,         0x10000142, VX , General        , 0                 , "Vector Maximum Signed Half Word"),
  INSTRUCTION(vmaxsw,         0x10000182, VX , General        , 0                 , "Vector Maximum Signed Word"),
  INSTRUCTION(vmaxub,         0x10000002, VX , General        , 0                 , "Vector Maximum Unsigned Byte"),
  INSTRUCTION(vmaxuh,         0x10000042, VX , General        , 0                 , "Vector Maximum Unsigned Half Word"),
  INSTRUCTION(vmaxuw,         0x10000082, VX , General        , 0                 , "Vector Maximum Unsigned Word"),
  INSTRUCTION(vminfp,         0x1000044A, VX , General        , 0                 , "Vector Minimum Floating Point"),
  INSTRUCTION(vminsb,         0x10000302, VX , General        , 0                 , "Vector Minimum Signed Byte"),
  INSTRUCTION(vminsh,         0x10000342, VX , General        , 0                 , "Vector Minimum Signed Half Word"),
  INSTRUCTION(vminsw,         0x10000382, VX , General        , 0                 , "Vector Minimum Signed Word"),
  INSTRUCTION(vminub,         0x10000202, VX , General        , 0                 , "Vector Minimum Unsigned Byte"),
  INSTRUCTION(vminuh,         0x10000242, VX , General        , 0                 , "Vector Minimum Unsigned Half Word"),
  INSTRUCTION(vminuw,         0x10000282, VX , General        , 0                 , "Vector Minimum Unsigned Word"),
  INSTRUCTION(vmrghb,         0x1000000C, VX , General        , 0                 , "Vector Merge High Byte"),
  INSTRUCTION(vmrghh,         0x1000004C, VX , General        , 0                 , "Vector Merge High Half Word"),
  ...
  INSTRUCTION(vmrglh,         0x1000014C, VX , General        , 0                 , "Vector Merge Low Half Word"),
  INSTRUCTION(vmrglw,         0x1000018C, VX , General        , 0                 , "Vector Merge Low Word"),
  INSTRUCTION(vmulesb,        0x10000308, VX , General        , 0                 , "Vector Multiply Even Signed Byte"),
  INSTRUCTION(vmulesh,        0x10000348, VX , General        , 0                 , "Vector Multiply Even Signed Half Word"),
  INSTRUCTION(vmuleub,        0x10000208, VX , General        , 0                 , "Vector Multiply Even Unsigned Byte"),
  INSTRUCTION(vmuleuh,        0x10000248, VX , General        , 0                 , "Vector Multiply Even Unsigned Half Word"),
  INSTRUCTION(vmulosb,        0x10000108, VX , General        , 0                 , "Vector Multiply Odd Signed Byte"),
  ...
  INSTRUCTION(vpkswss,        0x100001CE, VX , General        , 0                 , "Vector Pack Signed Word Signed Saturate"),
  INSTRUCTION(vpkswus,        0x1000014E, VX , General        , 0                 , "Vector Pack Signed Word Unsigned Saturate"),
  INSTRUCTION(vpkuhum,        0x1000000E, VX , General        , 0                 , "Vector Pack Unsigned Half Word Unsigned Modulo"),
  INSTRUCTION(vpkuhus,        0x1000008E, VX , General        , 0                 , "Vector Pack Unsigned Half Word Unsigned Saturate"),
  INSTRUCTION(vpkuwum,        0x1000004E, VX , General        , 0                 , "Vector Pack Unsigned Word Unsigned Modulo"),
  INSTRUCTION(vpkuwus,        0x100000CE, VX , General        , 0                 , "Vector Pack Unsigned Word Unsigned Saturate"),
  INSTRUCTION(vrefp,          0x1000010A, VX , General        , 0                 , "Vector Reciprocal Estimate Floating Point"),
  INSTRUCTION(vrfim,          0x100002CA, VX , General        , 0                 , "Vector Round to Floating-Point Integer toward -Infinity"),
  INSTRUCTION(vrfin,          0x1000020A, VX , General        , 0                 , "Vector Round to Floating-Point Integer Nearest"),
  INSTRUCTION(vrfip,          0x1000028A, VX , General        , 0                 , "Vector Round to Floating-Point Integer toward +Infinity"),
  INSTRUCTION(vrfiz,          0x1000024A, VX , General        , 0                 , "Vector Round to Floating-Point Integer toward Zero"),
  INSTRUCTION(vrlb,           0x10000004, VX , General        , 0                 , "Vector Rotate Left Integer Byte"),
  INSTRUCTION(vrlh,           0x10000044, VX , General        , 0                 , "Vector Rotate Left Integer Half Word"),
  ...
  INSTRUCTION(vsubshs,        0x10000740, VX , General        , 0                 , "Vector Subtract Signed Half Word Saturate"),
  INSTRUCTION(vsubsws,        0x10000780, VX , General        , 0                 , "Vector Subtract Signed Word Saturate"),
  INSTRUCTION(vsububm,        0x10000400, VX , General        , 0                 , "Vector Subtract Unsigned Byte Modulo"),
  INSTRUCTION(vsububs,        0x10000600, VX , General        , 0                 , "Vector Subtract Unsigned Byte Saturate"),
  INSTRUCTION(vsubuhm,        0x10000440, VX , General        , 0                 , "Vector Subtract Unsigned Half Word Modulo"),
  INSTRUCTION(vsubuhs,        0x10000640, VX , General        , 0                 , "Vector Subtract Unsigned Half Word Saturate"),
  INSTRUCTION(vsubuwm,        0x10000480, VX , General        , 0                 , "Vector Subtract Unsigned Word Modulo"),
  INSTRUCTION(vsubuws,        0x10000680, VX , General        , 0                 , "Vector Subtract Unsigned Word Saturate"),
  INSTRUCTION(vsumsws,        0x10000788, VX , General        , 0                 , "Vector Sum Across Signed Word Saturate"),
  INSTRUCTION(vsum2sws,       0x10000688, VX , General        , 0                 , "Vector Sum Across Partial (1/2) Signed Word Saturate"),
  INSTRUCTION(vsum4sbs,       0x10000708, VX , General        , 0                 , "Vector Sum Across Partial (1/4) Signed Byte Saturate"),
  INSTRUCTION(vsum4shs,       0x10000648, VX , General        , 0                 , "Vector Sum Across Partial (1/4) Signed Half Word Saturate"),
  INSTRUCTION(vsum4ubs,       0x10000608, VX , General        , 0                 , "Vector Sum Across Partial (1/4) Unsigned Byte Saturate"),
  INSTRUCTION(vupkhpx,        0x1000034E, VX , General        , 0                 , "Vector Unpack High Pixel"),
  INSTRUCTION(vupkhsb,        0x1000020E, VX , General        , 0                 , "Vector Unpack High Signed Byte"),
  INSTRUCTION(vupkhsh,        0x1000024E, VX , General        , 0                 , "Vector Unpack High Signed Half Word"),
...
static InstrType instr_table_scan[] = {
  SCAN_INSTRUCTION(vcmpbfp,        0x100003C6,       VXR     , General       , 0               , "Vector Compare Bounds Floating Point"),
  SCAN_INSTRUCTION(vcmpeqfp,       0x100000C6,       VXR     , General       , 0               , "Vector Compare Equal-to Floating Point"),
  SCAN_INSTRUCTION(vcmpequb,       0x10000006,       VXR     , General       , 0               , "Vector Compare Equal-to Unsigned Byte"),
  SCAN_INSTRUCTION(vcmpequh,       0x10000046,       VXR     , General       , 0               , "Vector Compare Equal-to Unsigned Half Word"),
  SCAN_INSTRUCTION(vcmpequw,       0x10000086,       VXR     , General       , 0               , "Vector Compare Equal-to Unsigned Word"),
  SCAN_INSTRUCTION(vcmpgefp,       0x100001C6,       VXR     , General       , 0               , "Vector Compare Greater-Than-or-Equal-to Floating Point"),
  SCAN_INSTRUCTION(vcmpgtfp,       0x100002C6,       VXR     , General       , 0               , "Vector Compare Greater-Than Floating Point"),
  SCAN_INSTRUCTION(vcmpgtsb,       0x10000306,       VXR     , General       , 0               , "Vector Compare Greater-Than Signed Byte"),
  SCAN_INSTRUCTION(vcmpgtsh,       0x10000346,       VXR     , General       , 0               , "Vector Compare Greater-Than Signed Half Word"),
  SCAN_INSTRUCTION(vcmpgtsw,       0x10000386,       VXR     , General       , 0               , "Vector Compare Greater-Than Signed Word"),
