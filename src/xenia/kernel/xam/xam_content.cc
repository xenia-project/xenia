...
dword_result_t XamContentGetLicenseMask(lpdword_t mask_ptr, pointer_t<XAM_OVERLAPPED> overlapped_ptr) {
...
dword_result_t XamContentGetDeviceName(dword_t device_id, lpdword_t name_ptr, dword_t name_capacity) {
	...
	xe::store_and_swap<std::wstring>(name_ptr,
...
dword_result_t XamContentResolve(dword_t user_index, lpvoid_t content_data_ptr, lpdword_t buffer_ptr, dword_t buffer_size, dword_t unk1, dword_t unk2, dword_t unk3) {
	// unk1 1
	// unk2 0
	// unk3 0
...
DECLARE_XAM_EXPORT(XamContentResolve, ExportTag::kStub);
...
dword_result_t XamContentFlush(lpdword_t root_name_ptr, pointer_t<XAM_OVERLAPPED> overlapped_ptr) {
...
DECLARE_XAM_EXPORT(XamContentFlush, ExportTag::kImplemented);

dword_result_t XamContentClose(lpstring_t root_name_ptr, pointer_t<XAM_OVERLAPPED> overlapped_ptr) {
	auto root_name = xe::load_and_swap<std::string>(root_name_ptr);
...
dword_result_t XamContentDelete(dword_t user_index, lpvoid_t content_data_ptr, pointer_t<XAM_OVERLAPPED> overlapped_ptr) {
