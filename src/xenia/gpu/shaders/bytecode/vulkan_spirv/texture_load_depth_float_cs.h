...
%uint_4294967277 = OpConstant %uint 4294967277
      ...
      %24661 = OpSelect %v4uint %12703 %2896 %22396
       %8770 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %21685
               OpStore %8770 %24661
      ...
      %11069 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %21686
               OpStore %11069 %24662
               OpBranch %19578
      %19578 = OpLabel
               OpReturn
...
const uint32_t texture_load_depth_float_cs[] = {
    ...
    0x00000438, 0x000600A9, 0x00000017, 0x00002A9E, 0x000040CA, 0x0000499B,
    ...
    0x00000017, 0x00003FA7, 0x00002A9E, 0x0000002F, 0x000500C5, 0x00000017,
