...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
    ...
    %uint_15 = OpConstant %uint 15
      ...
      %24825 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %9579
               OpStore %24825 %19767
      %19686 = OpIAdd %uint %9579 %int_1
      %13384 = OpIAdd %uint %14664 %uint_1
      %14268 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_source %int_0 %13384
       %6578 = OpLoad %v4uint %14268
      ...
      %16377 = OpBitwiseOr %v4uint %9426 %17550
               OpBranch %11417
      %11417 = OpLabel
      %19768 = OpPhi %v4uint %6578 %11416 %16377 %10584
       %8053 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %19686
               OpStore %8053 %19768
               OpBranch %19578
      %19578 = OpLabel
               OpReturn
...
const uint32_t texture_load_16bpb_scaled_cs[] = {
    ...
    0x0000000B, 0x00004CE6, 0x0000256B, 0x00000A0E, 0x00050080, 0x0000000B,
    0x00003448, 0x00003948, 0x00000A0D, 0x00060041, 0x00000294, 0x000037BC,
    0x0000107A, 0x00000A0B, 0x00003448, 0x0004003D, 0x00000017, 0x000019B2,
    0x000037BC, 0x000300F7, 0x00002C99, 0x00000000, 0x000400FA, 0x00005272,
    ...
    0x000019B2, 0x00002C98, 0x00003FF9, 0x00002958, 0x00060041, 0x00000294,
    0x00001F75, 0x0000140E, 0x00000A0B, 0x00004CE6, 0x0003003E, 0x00001F75,
