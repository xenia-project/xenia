...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
    ...
    %uint_15 = OpConstant %uint 15
      ...
      %24121 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %9579
               OpStore %24121 %12287
      ...
      %16377 = OpBitwiseOr %v4uint %9426 %17550
               OpBranch %14874
      %14874 = OpLabel
      %10924 = OpPhi %v4uint %17834 %13867 %16377 %10584
      ...
      %12288 = OpBitcast %v4uint %21749
       %7349 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %7576
               OpStore %7349 %12288
               OpBranch %19578
      %19578 = OpLabel
               OpReturn
...
const uint32_t texture_load_depth_unorm_scaled_cs[] = {
    ...
    0x000042F0, 0x0000073F, 0x00050086, 0x00000011, 0x00003D7E, 0x00002D96,
    ...
    0x00000011, 0x00002BE0, 0x00003D7E, 0x0000073F, 0x00050051, 0x0000000B,
    ...
    0x00005E39, 0x0000140E, 0x00000A0B, 0x0000256B, 0x0003003E, 0x00005E39,
    0x00002FFF, 0x00050080, 0x0000000B, 0x00001D98, 0x0000256B, 0x00000A0E,
    ...
    0x00000017, 0x000045AA, 0x00003849, 0x000300F7, 0x00003A1A, 0x00000000,
    ...
    0x00000017, 0x00002AAC, 0x000045AA, 0x0000362B, 0x00003FF9, 0x00002958,
    ...
    0x0000140E, 0x00000A0B, 0x00001D98, 0x0003003E, 0x00001CB5, 0x00003000,
