...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
    ...
    %uint_64 = OpConstant %uint 64
      ...
      %16376 = OpBitwiseOr %v4uint %9425 %17549
               OpBranch %12537
      %12537 = OpLabel
      %12106 = OpPhi %v4uint %8801 %19040 %16376 %10583
      ...
      %17859 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %16224
               OpStore %17859 %15035
      ...
      %16377 = OpBitwiseOr %v4uint %9426 %17550
               OpBranch %12538
      %12538 = OpLabel
      %12107 = OpPhi %v4uint %17834 %6871 %16377 %10584
      ...
      %20158 = OpAccessChain %_ptr_Uniform_v4uint %xe_texture_load_dest %int_0 %21685
               OpStore %20158 %15036
               OpBranch %19578
      %19578 = OpLabel
               OpReturn
...
const uint32_t texture_load_r16_snorm_float_cs[] = {
    ...
    0x00005E63, 0x00000A39, 0x000500C5, 0x0000000C, 0x00003C71, 0x00003C82,
    ...
    0x000030F9, 0x00000000, 0x000400FA, 0x00005272, 0x00002957, 0x000030F9,
    ...
    0x00003FF8, 0x000024D1, 0x0000448D, 0x000200F9, 0x000030F9, 0x000200F8,
    0x000030F9, 0x000700F5, 0x00000017, 0x00002F4A, 0x00002261, 0x00004A60,
    0x00003FF8, 0x00002957, 0x0004007C, 0x0000001A, 0x00003C0F, 0x00002F4A,
    ...
    0x00060041, 0x00000294, 0x000045C3, 0x0000140E, 0x00000A0B, 0x00003F60,
    ...
    0x0004003D, 0x00000017, 0x000045AA, 0x000057A7, 0x000300F7, 0x000030FA,
    ...
    0x000700F5, 0x00000017, 0x00002F4B, 0x000045AA, 0x00001AD7, 0x00003FF9,
    ...
    0x00000294, 0x00004EBE, 0x0000140E, 0x00000A0B, 0x000054B5, 0x0003003E,
