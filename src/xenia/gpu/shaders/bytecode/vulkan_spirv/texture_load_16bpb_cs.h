...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
    ...
    %uint_64 = OpConstant %uint 64
      ...
      %16377 = OpBitwiseOr %v4uint %9426 %17550
               OpBranch %11417
      %11417 = OpLabel
      %19768 = OpPhi %v4uint %6578 %6871 %16377 %10584
...
const uint32_t texture_load_16bpb_cs[] = {
    ...
    0x00004571, 0x00000ACA, 0x000055E9, 0x00000A3A, 0x00001C25, 0x000500C2,
    ...
    0x0000571A, 0x000300F7, 0x00002C99, 0x00000000, 0x000400FA, 0x00005272,
    ...
    0x000019B2, 0x00001AD7, 0x00003FF9, 0x00002958, 0x00060041, 0x00000294,
