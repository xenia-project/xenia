	...
	namespace gpu {
		namespace vulkan {
			...
			static const TextureConfig texture_configs[64] = {
				...
				{ TextureFormat::kUnknown, VK_FORMAT_UNDEFINED },
				{ TextureFormat::k_24_8, VK_FORMAT_D32_SFLOAT_S8_UINT },  // Causes AMD cards to crash when set to VK_FORMAT_D24_UNORM_S8_UINT
				{ TextureFormat::k_24_8_FLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT },  // Causes AMD cards to crash when set to VK_FORMAT_D24_UNORM_S8_UINT
