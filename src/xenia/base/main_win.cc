...
CVar(win32_high_freq, true,                     "Audio system. Use: [any, nop, xaudio2]", "General");
namespace xe {
...
int Main() {
  ...
  config::ParseLaunchArguments(argca, argva);
  config::SetupConfig(xe::filesystem::GetExecutableFolder());
  ...
  if (var_win32_high_freq.GetBool()) {
