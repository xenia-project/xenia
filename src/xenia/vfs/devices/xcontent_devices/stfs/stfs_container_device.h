...
#ifndef XENIA_VFS_DEVICES_XCONTENT_DEVICES_STFS_STFS_CONTAINER_DEVICE_H_
#define XENIA_VFS_DEVICES_XCONTENT_DEVICES_STFS_STFS_CONTAINER_DEVICE_H_
...
#endif  // XENIA_VFS_DEVICES_XCONTENT_DEVICES_STFS_STFS_CONTAINER_DEVICE_H_
