...
static InstrType instr_table_31_unprep[] = {
    ...
    INSTRUCTION(mulhwx, 0x7C000096, XO, General, XO_RT_RA_RB,
                "Multiply High Word"),
    INSTRUCTION(mfmsr, 0x7C0000A6, X, SynchronizeContext, mfmsr,
    ...
    INSTRUCTION(mtmsr, 0x7C000124, X, SynchronizeContext, mtmsr,
    ...
    INSTRUCTION(mtmsrd, 0x7C000164, X, SynchronizeContext, mtmsr,
